...
export default class App extends React.Component {
  ...
  deleteItem = (id) => {
    ...
    localStorage.setItem('state', JSON.stringify(this.state.todoData.filter((el) => el.id !== id)));
  };
  ...
  deleteCompletedItem = () => {
    ...
    localStorage.setItem('state', JSON.stringify(this.state.todoData.filter((el) => !el.done)));
  };
